      ...
      <table class="table" id="myTable" width="100%">
        ...
        @foreach($sales as $sale)
          <tr class="text-center">
            ...
            <td>
              <a target="_blank" href="{{ route('sale.show', $sale->sale_id) }}" class="btn btn-outline-dark btn btn-sm btn-bold">View</a>
            </td>
          </tr>
          <?php $Gtotal += $sale->total_price; $totalQty += $sale->quantity; ?>
        @endforeach
        </tbody>
