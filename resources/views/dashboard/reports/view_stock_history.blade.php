    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">Stock History By (Product Name: {{$product->name}}) </h3>
            </div>
        </div>
            ...
            <table class="table" id="myTable" width="100%">
                ...
                @foreach ($purchases as $purchase)
                    <tr>
                        ...
                        <td>{{ ($purchase->purchase_date?date('M d Y', strtotime($purchase->purchase_date)):'') }}</td>
                        <td>{{ $purchase->name }}</td>
                        ...
                        <td nowrap='nowrap'>
                            <a target="_blank" href="{{ route('purchase.show', $purchase->purchase_id) }}" class="btn btn-sm btn-icon btn-clean text-hover-primary"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
