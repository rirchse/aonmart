<div class="form-group row">
  ...
  <div class="col-lg-8">
    ...
    <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
      <div id="image" class="kt-avatar__holder_icon" style="background-image: url('{{ $user->image }}')"></div>
      <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
        <i class="fa fa-pen"></i>
        <input type="file" value="{{ old('image', $user->image) }}" class="@error('image') is-invalid @enderror" onchange="readURL(this)" name="image" accept=".png, .jpg, .jpeg">
      </label>
...
<div class="form-group row">
  ...
  <div class="col-lg-8">
    ...
    <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
      <div id="cover_image" class="kt-avatar__holder_cover" style="background-image: url('{{ $user->cover_image }}')"></div>
      <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
        <i class="fa fa-pen"></i>
        <input type="file" value="{{old('cover_image', $user->cover_image)}}" class="@error('cover_image') is-invalid @enderror" onchange="readURLCover(this)" name="cover_image" accept=".png, .jpg, .jpeg">
      </label>
...
<div class="form-group row">
  ...
  <div class="col-lg-8">
    ...
    <input name="name" id="name" value="{{ old('name', $user->name) }}" placeholder="Customer Name" type="text" class="form-control  @error('name') is-invalid @enderror">
    @error('name')
...
<div class="form-group row">
  ...
  <div class="col-lg-8">
    ...
    <textarea class="form-control @error('about') is-invalid @enderror" id="about" name="about" placeholder="Bio" minlength="100" maxlength="1000" rows="5">{{ old('about', $user->about) }}</textarea>
    @error('about')
    <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
      </span>
