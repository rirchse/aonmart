...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">Add New Feature</h3>
        </div>
    ...
    <div class="card-body">
        ...
        <form class="kt-form kt-form--label-right" enctype="multipart/form-data" method="POST" action="{{route('feature.store')}}">
            @csrf
            <div class="kt-portlet__body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-8">
                  <input name="priority" id="priority" min="0" value="{{old('priority') ?? 0}}" placeholder="Ex: 1" type="number" class="form-control  @error('priority') is-invalid @enderror">
                  @error('priority')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-8">
                  <select class="form-control select2" multiple name="products_id[]">
                    <option value="">-- Select Feature Products --</option>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="image-input image-input-outline">
                        ...
                        <label
                            ...
                            <input type="file" value="{{old('image')}}" class="@error('image') is-invalid @enderror"
                  ...
                  {{-- <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                    ...
                    <label class="col-md-2 col-form-label" class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                      <i class="fa fa-pen"></i>
