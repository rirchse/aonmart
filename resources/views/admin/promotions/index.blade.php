  ...
  <div class="card card-custom">
    <div class="card-header">
      ...
      <div class="card-toolbar">
        <a href="{{ route('promotions.create') }}" class="btn btn-primary font-weight-bolder">
      ...
      <table class="table" id="myTable" width="100%">
        ...
        @foreach($promotions as $promotion)
          <tr>
            ...
            <td>
              <span class="label font-weight-bold label-lg label-light-info label-inline">{{ $promotion->status ? 'Active' : 'Inactive' }}</span>


            </td>
            <td>
              <form method="post" action="{{ route('promotions.destroy',$promotion->id) }}">
                <a href="{{ route('promotions.edit',$promotion->id) }}" class="btn btn-sm  btn-clean btn-icon"><i class="la la-edit icon-lg"></i></a>
                @csrf
                @method('DELETE')
