  ...
  <div class="card card-custom">
    ...
    <div class="card-body">
      ...
      auth()->user()->hasRole('Super Admin'))
                  <a href="{{ route('expenses.approve', $expense->id) }}" onclick="return confirm('Are you sure to approve this expense?');" class="btn btn-sm text-hover-success btn-clean btn-icon text-dark" title="Approve"><i class="fas fa-check"></i></a>
                @endif
                <a href="{{ route('expenses.edit', $expense->id) }}" class="btn btn-sm btn-clean btn-icon text-dark"><i class="la la-edit icon-lg"></i></a>
