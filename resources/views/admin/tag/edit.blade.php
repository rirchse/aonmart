...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">Edit tag</h3>
        </div>
    ...
    <div class="card-body">
        <form class="form" enctype="multipart/form-data" method="POST" action="{{route('tag.update', $tag->id)}}">
            @csrf
            @method('PUT')
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="image-input image-input-outline">
                    <div class="image-input-wrapper" id="icon" style="background-image: url({{asset('storage/'.$tag->icon)}})">
                    </div>
